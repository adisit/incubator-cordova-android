 ...
 *
 *     public class Examples extends TLWebActivity {
 *       @Override
 ...
 *      </plugins>
 */
public class TLWebActivity extends Activity implements CordovaInterface {
    ...
    */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LOG.d(TAG, "TLWebActivity.onCreate()");
        super.onCreate(savedInstanceState);
     ...
     */
    public void init() {
        CordovaWebView webView = new CordovaWebView(TLWebActivity.this);
    ...
    public void loadUrl(String url) {
    	...
    	LOG.w(TAG + ".URL", "loadUrl URL : " + url);
    	Log.w(TAG, "loadUrl URL : " + url);
    ...
    public void loadUrl(final String url, int time) {
    	...
    	LOG.w(TAG + ".URL", "loadUrl URL2 : " + url);
    ...
    public void spinnerStart(final String title, final String message) {
        ...
        final TLWebActivity me = this;
        this.spinnerDialog = ProgressDialog.show(TLWebActivity.this, title, message, true, true,
    ...
    public boolean isUrlWhiteListed(String url) {
    	LOG.w(TAG + ".URL", "isUrlWhiteListed URL : " + url);
    ...
    /*
     * Hook in TLWebActivity for menu plugins
     *
     */
    @Override
